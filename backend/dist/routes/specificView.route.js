...
import { specificDesigns, specificDevelopments, specificDsa, specificFlex, specificJob, } from "../controllers/specificView.controller.js";
const router = express.Router();
router.get("/specificDesigns/:designerOpportunity_id", specificDesigns);
router.get("/specificDevelopments/:developerOpportunity_id", specificDevelopments);
