  ...
  return (
    <div className="min-h-screen bg-[#1a191a] text-gray-100">
      <div className="max-w-4xl mx-auto p-6">
        ...
        <h1 className="text-4xl font-bold text-[#e3a428] mb-4">Title</h1>
        ...
        <div className="mt-8">
          ...
          <div className="bg-[#232223] rounded-2xl p-4">
            ...
            <div className="flex justify-end mt-4">
              <button className="bg-[#e3a428] hover:bg-[#c38d22] text-white font-bold py-2 px-6 rounded-full transition-colors">
                Post Comment
              </button>
            </div>
          </div>
