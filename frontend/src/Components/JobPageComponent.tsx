...
const JobPageComponent = ({title,description,company,location,salary,applyLink}:{title:string,description:string,company:string,location:string,salary:string,applyLink:string}) => {
  return (
