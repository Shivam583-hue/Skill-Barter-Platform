...
const DesignerPageComponent = ({title,description,commentCount,postedOn,Createdby,creatorimage}:{title:string,description:string,commentCount:number,postedOn:string,Createdby:string,creatorimage:string}) => {
  return (
